...
public class VerificationFingerprintLockActivity extends AppCompatActivity {
    ...
    private void showToast(String msg){
        Toast.makeText(VerificationFingerprintLockActivity.this,msg,Toast.LENGTH_LONG).show();
    }
